...
APP_PATH="${1:-dist/FitBootstrap.app}"
VERSION="${2:-}"
OUT_DIR="${3:-dist/dmg}"
...
ARCH="$(uname -m)"
DMG_NAME="fit-bootstrap-portable-${VERSION}-macos-${ARCH}.dmg"
DMG_PATH="${OUT_DIR}/${DMG_NAME}"
RW_DMG_PATH="${OUT_DIR}/fit-bootstrap-rw-${VERSION}.dmg"
VOL_NAME="FitBootstrap-${VERSION}"
...
ditto "${APP_PATH}" "${MOUNT_POINT}/FitBootstrap.app"
